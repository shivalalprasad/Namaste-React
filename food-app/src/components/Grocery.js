    ...
    <section className="text-gray-600 body-font">
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-8 mx-auto">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-2">Tomato Grocery
            <br className="hidden sm:block" />get everything of daily kitchen
          </h1>
        </div>
      </section>
