...
const Contact = () =>{
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Drop Your Query <br/> we don't share your details to any one else</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-300 text-center">
          <a href="mailto:shivalalprasad@flash.co" className="text-indigo-500">shivalalprasad@flash.co</a>
